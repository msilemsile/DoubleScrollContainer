...
import com.memebox.cn.android.widget.scroller.CustomOverScroller;
...
//        setScrollViewScroller();
    }

    /**
     * set ScrollView scroller to change animation duration when sliding
     */
    private void setScrollViewScroller() {
        try {
            Field scrollerField = ScrollView.class.getDeclaredField("mScroller");
            scrollerField.setAccessible(true);
            mScroller = new CustomOverScroller(getContext());
            mScroller.setScrollDurationFactor(1.5);
